export default function VideoCardSkeletons() {
  return (
    <div className='relative w-full h-full max-w-xs overflow-hidden text-black transition-all rounded-lg bg-neutral-700 group hover:rounded-none [&_p]:animate-pulse aspect-video'>
